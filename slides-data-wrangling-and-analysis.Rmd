...
I'll be working with the following data: [State of Oregon 2018-2019 school attendance data](https://www.oregon.gov/ode/reports-and-data-raw/students/Documents/fallmembershipreport_20182019.xlsx) and [State of Oregon 2018-2019 3rd grade math proficiency data](https://www.oregon.gov/ode/reports-and-data-raw/students/Documents/regularattenders_report_1819.xlsx)
...
TK: I took this out. Make sure it's ok.
...
1. [State of Oregon 3rd grade 2018-2019 enrollment data](https://www.oregon.gov/ode/reports-and-data-raw/students/Documents/fallmembershipreport_20182019.xlsx)
...
background-image:url("images/sound-of-music.jpg")

# A Few of My Favorite ~~Things~~ Functions for Data Analysis
...
```{r}
german_speakers_2019 %>% 
  mutate(quartile = ntile(number, 4))
```
