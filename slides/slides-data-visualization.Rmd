...
### Use Custom Fonts in RStudio

![](images/graphics-device.png)

---

### Use Custom Fonts with `ggsave()`

```{r}
ggsave("myplot.png", device = agg_png)
```

--

Make sure you load the `ragg` package first

---

### Use Custom Fonts when Knitting an RMarkdown File
...
1. Change your settings in RStudio so you can render with AGG

--

1. Change all text in your last plot to use a custom font (you'll have to do this in a few different places)

--

1. Save your plot using `ggsave()`
